	...
	<view class="select-city-wrap">
		<view class="select-city">
			...
			<scroll-view :scroll-into-view="scrollIntoId" :scroll-y="true" :scroll-with-animation="true" :style="{height:windowHeight}">
				<view class="content">
					<view class="section" id="current" v-if="showPositon">
						<view class="city-title">当前城市</view>
						<view class="city-list">
							<view v-if="currentCity" class="city-item" :class="{active: current === currentCity}" @click="onSelect(currentCity)">{{currentCity}}</view>
              <view v-else  class="city-item" >定位中...</view>
						</view>
					</view>
